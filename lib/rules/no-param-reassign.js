...
module.exports = {
    ...
    create(context) {
        ...
        const ignoredPropertyAssigmentsFor = context.options[0] && context.options[0].ignorePropertyAssignmentsFor || [];
        ...
        function checkReference(reference, index, references) {
            ...
            if (identifier &&
                ...
                } else if (props && isModifyingProp(reference) && ignoredPropertyAssigmentsFor.indexOf(identifier.name) === -1) {
